...
struct regulator_init_data dlxp_saw_regulator_pdata_8921_s5 =
	/*	      ID  vreg_name	       min_uV   max_uV */
	SAW_VREG_INIT(S5, "8921_s5",	       700000, 1300000);
struct regulator_init_data dlxp_saw_regulator_pdata_8921_s6 =
	SAW_VREG_INIT(S6, "8921_s6",	       700000, 1300000);

struct regulator_init_data dlxp_saw_regulator_pdata_8821_s0 =
	/*	      ID       vreg_name	min_uV  max_uV */
	SAW_VREG_INIT(8821_S0, "8821_s0",       700000, 1300000);
struct regulator_init_data dlxp_saw_regulator_pdata_8821_s1 =
...
dlxp_rpm_regulator_init_data[] __devinitdata = {
...
int dlxp_pm8921_regulator_pdata_len __devinitdata =
	ARRAY_SIZE(dlxp_pm8921_regulator_pdata);
...
struct rpm_regulator_platform_data dlxp_rpm_regulator_pdata __devinitdata = {
	.init_data		= dlxp_rpm_regulator_init_data,
	.num_regulators		  = ARRAY_SIZE(dlxp_rpm_regulator_init_data),
