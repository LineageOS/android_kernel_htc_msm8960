...
static struct platform_device mipi_dsi_dlxp_panel_device = {
	.name   = "mipi_dlxp",
	.id = 0,
};
...
static void __init dlxp_set_display_params(char *prim_panel, char *ext_panel)
{
...
void __init dlxp_init_fb(void)
{
	...
	if (panel_type == PANEL_ID_DLXP_SHARP_RENESAS)
