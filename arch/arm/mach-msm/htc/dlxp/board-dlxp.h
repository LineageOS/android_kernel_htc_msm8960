...
int __init dlxp_init_keypad(void);
...
extern struct pm8xxx_regulator_platform_data
	dlxp_pm8921_regulator_pdata[] __devinitdata;

extern int dlxp_pm8921_regulator_pdata_len __devinitdata;
...
extern struct gpio_regulator_platform_data
	dlxp_gpio_regulator_pdata[] __devinitdata;

extern struct rpm_regulator_platform_data
	dlxp_rpm_regulator_pdata __devinitdata;

extern struct regulator_init_data dlxp_saw_regulator_pdata_8921_s5;
extern struct regulator_init_data dlxp_saw_regulator_pdata_8921_s6;
extern struct regulator_init_data dlxp_saw_regulator_pdata_8821_s0;
extern struct regulator_init_data dlxp_saw_regulator_pdata_8821_s1;

struct mmc_platform_data;
int __init apq8064_add_sdcc(unsigned int controller,
		struct mmc_platform_data *plat);

void dlxp_init_mmc(void);
int dlxp_wifi_init(void);
void dlxp_init_gpiomux(void);
void dlxp_init_pmic(void);

#if 1	// for pre-evt no camera
extern struct platform_device dlxp_msm_rawchip_device;
#endif
void dlxp_init_cam(void);

#define APQ_8064_GSBI1_QUP_I2C_BUS_ID 0
#define APQ_8064_GSBI3_QUP_I2C_BUS_ID 3
#define APQ_8064_GSBI4_QUP_I2C_BUS_ID 4

void dlxp_init_fb(void);
void dlxp_allocate_fb_region(void);
void dlxp_mdp_writeback(struct memtype_reserve *reserve_table);

void dlxp_init_gpu(void);
void dlxp_pm8xxx_gpio_mpp_init(void);
void dlxp_usb_uart_switch(int nvbus);
