...
void dlxp_cable_detect_register(void)
{
	int rc;
...
static struct wcd9xxx_pdata dlxp_tabla_platform_data = {
...
static struct slim_device dlxp_slim_tabla = {
	.name = "tabla-slim",
	.e_addr = {0, 1, 0x10, 0, 0x17, 2},
	.dev = {
		.platform_data = &dlxp_tabla_platform_data,
	},
};

static struct wcd9xxx_pdata dlxp_tabla20_platform_data = {
	.slimbus_slave_device = {
		.name = "tabla-slave",
...
static struct slim_device dlxp_slim_tabla20 = {
	.name = "tabla2x-slim",
	.e_addr = {0, 1, 0x60, 0, 0x17, 2},
	.dev = {
		.platform_data = &dlxp_tabla20_platform_data,
	},
};
...
static struct htc_battery_platform_data htc_battery_pdev_data = {
	...
	.igauge.get_battery_cc = pm8921_bms_get_batt_cc,wer_voltage_alarm_notifier =
...
#ifdef CONFIG_ANDROID_PMEM
#ifndef CONFIG_MSM_MULTIMEDIA_USE_ION
	&dlxp_android_pmem_device,
	&dlxp_android_pmem_adsp_device,
	&dlxp_android_pmem_audio_device,
#endif /*CONFIG_MSM_MULTIMEDIA_USE_ION*/
#endif /*CONFIG_ANDROID_PMEM*/
#ifdef CONFIG_ION_MSM
	&dlxp_ion_dev,
...
static void __init dlxp_init_dsps(void)
{
...
static void __init dlxp_fixup(struct tag *tags, char **cmdline, struct meminfo *mi)
{
	...
	printk(KERN_INFO "DLXP_fixup:skuid=0x%x\n", skuid);
}
