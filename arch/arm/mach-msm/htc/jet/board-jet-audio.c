...
#define PAMP_GPIO	(PM8921_GPIO_PM_TO_SYS(JET_GPIO_AUD_AMP_EN))
...
static int __init jet_audio_init(void)
{
	...
	rc = gpio_request(PM8921_GPIO_PM_TO_SYS(JET_GPIO_AUD_AMP_EN),
					"jet_en");
	rc = pm8xxx_gpio_config(PM8921_GPIO_PM_TO_SYS(JET_GPIO_AUD_AMP_EN),
			&param);
	if (rc < 0)
		pr_debug("failed to configure tpa2051_en gpio\n");
