...
static int mipi_video_auo_hd720p_init(void)
{
	...
	pinfo.lcdc.h_back_porch = 160;	/* 660Mhz: 116 */
	pinfo.lcdc.h_front_porch = 160;	/* 660Mhz: 184 */
	pinfo.lcdc.h_pulse_width = 8;	/* 660Mhz: 24 */
	...
	pinfo.mipi.t_clk_post = 0x04;	/* 660Mhz: 10 */
	pinfo.mipi.t_clk_pre = 0x1e;	/* 660Mhz: 30 */
